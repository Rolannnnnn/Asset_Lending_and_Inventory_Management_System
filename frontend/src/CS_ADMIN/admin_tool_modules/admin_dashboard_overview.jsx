        ...
        <div className="main-dashboard-container" style={{ textAlign: 'left' }}>
            <div className="card-container">
                ...
                <div style={{ marginTop: 24 }}>
                    ...
                    <h4 style={{ margin: '4px 0', color: '#6b7280', fontStyle: 'italic', textAlign: 'center'}}>Note: Decommissioned stocks is not included in the summary of each items and their graphs.*
</h4>
